...
export const STATUS_PILL_SUCCESS_BG = '#ebf9f4'
export const STATUS_PILL_SUCCESS_TEXT = '#2fb182'
export const STATUS_PILL_ERROR_BG = '#fdf4f6'
export const STATUS_PILL_ERROR_TEXT = '#e15a7a'
export const STATUS_PILL_WARNING_BG = '#fff7e6'
